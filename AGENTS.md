...
本文件适用于 `Personal-AI/` 目录及其全部子目录。所有参与本项目开发的 Codex Chat 和 Agent 都必须遵守以下规则。

## 1. 项目范围

- Git 仓库根目录是 `Personal-AI/`，项目文件直接位于仓库根目录。
- 仓库根级文件属于本项目；修改和提交应严格限定在当前任务范围。
